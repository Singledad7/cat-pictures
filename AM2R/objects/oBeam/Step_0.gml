...
if (x < __view_get( e__VW.XView, 0 ) - 48 - (oControl.widescreen_space/2) || x > __view_get( e__VW.XView, 0 ) + __view_get( e__VW.WView, 0 ) + 48 + (oControl.widescreen_space/2) || y < __view_get( e__VW.YView, 0 ) - 48 || y > __view_get( e__VW.YView, 0 ) + __view_get( e__VW.HView, 0 ) + 48) instance_destroy();
