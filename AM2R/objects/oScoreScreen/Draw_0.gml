if (state == 0) {
    ...
    draw_text(tx1x, tx1y, string_hash_to_newline(text1));
    draw_text(tx1x, tx1y + 12, string_hash_to_newline(text1a));
    draw_set_alpha(tx2_alpha);
    draw_text(tx1x, tx1y + 40, string_hash_to_newline(text2));
    draw_text(tx1x, tx1y + 52, string_hash_to_newline(text2a));
...
if (state == 1) {
    ...
    draw_set_alpha(tx1_alpha);
    draw_text(tx2x - 1 + widespace, tx2y - 1, string_hash_to_newline(text3));
    draw_text(tx2x - 1 + widespace, tx2y + 1, string_hash_to_newline(text3));
    draw_text(tx2x + 1 + widespace, tx2y - 1, string_hash_to_newline(text3));
    draw_text(tx2x + 1 + widespace, tx2y + 1, string_hash_to_newline(text3));
    draw_text(tx2x - 1 + widespace, tx2y, string_hash_to_newline(text3));
    draw_text(tx2x + 1 + widespace, tx2y, string_hash_to_newline(text3));
    draw_set_color(c_white);
    draw_set_alpha(tx1_alpha);
    draw_text(tx2x + widespace, tx2y, string_hash_to_newline(text3));
    draw_set_halign(fa_left);
}
if (state == 2) {
    draw_set_font(fontGUI2);
    ...
    draw_set_color(c_white);
    draw_set_alpha(tx1_alpha);
    draw_text(160, 100, string_hash_to_newline(text4));
    draw_set_halign(fa_right);
    draw_set_font(fontMenuSmall2);
    draw_set_alpha(tx2_alpha);
    draw_text(307 + widespace, 220, string_hash_to_newline(text5));
    draw_set_halign(fa_left);
}
if (fadeout) {
