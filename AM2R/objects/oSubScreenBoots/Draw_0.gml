...
if (global.item[4]) {
    ...
    draw_text(x - 20, y - 29 + oControl.subScrItemOffset, string_hash_to_newline(hijump));
}
if (global.item[6]) {
    draw_sprite(sSubScrButton, global.spacejump, x - 28, y - 19);
    draw_text(x - 20, y - 20 + oControl.subScrItemOffset, string_hash_to_newline(space));
}
if (global.item[7]) {
    draw_sprite(sSubScrButton, global.speedbooster, x - 28, y - 10);
    draw_text(x - 20, y - 11 + oControl.subScrItemOffset, string_hash_to_newline(speedbooster));
}
if (drawlines) {
...
draw_text(x + 1 - 30, y + 4 - 45 + oControl.subScrHeaderOffset, string_hash_to_newline(boots));
draw_set_color(c_white);
//draw_text(x - 30, y + 3 - 1, "SUIT");
//draw_text(x - 30, y + 3 - 63, "BEAM");
//draw_text(x - 30, y + 3 - 1, "MISC");
draw_text(x - 30, y + 3 - 45 + oControl.subScrHeaderOffset, string_hash_to_newline(boots));
