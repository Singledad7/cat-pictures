...
draw_text(x + 1 - 30, y + 4 - 63 + oControl.subScrHeaderOffset, string_hash_to_newline(beam));
//draw_text(x + 1 - 30, y + 4 - 1, "MISC");
//draw_text(x + 1 - 30, y + 4 - 45, "BOOTS");
draw_set_color(c_white);
//draw_text(x - 30, y + 3 - 1, "SUIT");
draw_text(x - 30, y + 3 - 63 + oControl.subScrHeaderOffset, string_hash_to_newline(beam));
