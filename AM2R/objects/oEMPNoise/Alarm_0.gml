with (oCharacter) if (turning == 0 && morphing == 0 && unmorphing == 0 && walljumping == 0 && (state == STANDING || state == RUNNING || state == DUCKING || state == JUMPING && vjump == 1) || state == GRIP && (facing == RIGHT && aimdirection != 0 || facing == LEFT && aimdirection != 1)) {
