...
draw_text(x - 20, y + 15 + oControl.subScrItemOffset, string_hash_to_newline(psuit));
if (global.item[5]) {
    draw_sprite(sSubScrButton, global.currentsuit == 1, x - 28, y + 25);
    draw_text(x - 20, y + 24 + oControl.subScrItemOffset, string_hash_to_newline(vsuit));
}
if (global.item[9]) {
    draw_sprite(sSubScrButton, global.currentsuit == 2, x - 28, y + 34);
    draw_text(x - 20, y + 33 + oControl.subScrItemOffset, string_hash_to_newline(gsuit));
}
draw_set_alpha(1);
draw_set_color(c_white);
if (drawlines) {
...
draw_text(x + 1 - 30, y + 4 - 1 + oControl.subScrHeaderOffset, string_hash_to_newline(suit));
//draw_text(x + 1 - 30, y + 4 - 63, "BEAM");
//draw_text(x + 1 - 30, y + 4 - 1, "MISC");
//draw_text(x + 1 - 30, y + 4 - 45, "BOOTS");
draw_set_color(c_white);
draw_text(x - 30, y + 3 - 1 + oControl.subScrHeaderOffset, string_hash_to_newline(suit));
