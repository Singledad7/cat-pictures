...
w = max(string_width(string_hash_to_newline(d0str)), string_width(string_hash_to_newline(d1str)), string_width(string_hash_to_newline(d2str)), string_width(string_hash_to_newline(d3str))) + 10;
