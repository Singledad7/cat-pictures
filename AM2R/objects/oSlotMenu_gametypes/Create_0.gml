//oGameSelMenu.op[3].can_highlight = 0;
global.curropt = 0;
lastitem = 2;
active = 0;
alarm[0] = 5;
...
w = max(string_width(string_hash_to_newline(d0str)), string_width(string_hash_to_newline(d1str)), string_width(string_hash_to_newline(d2str))) + 10;
