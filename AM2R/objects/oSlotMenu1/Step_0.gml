...
if (active) {
    ...
    if (oControl.kMenu1 && oControl.kMenu1PushedSteps == 0) {
        ...
        if (global.curropt == 1 || global.curropt == 2) event_user(1);
    }
...
if (fadeout) {
    if (h > 4) {
        ...
        if (global.curropt == 1) instance_create(0, -200, oSlotMenuCopy);
        if (global.curropt == 2) instance_create(x, y, oSlotMenuErase);
