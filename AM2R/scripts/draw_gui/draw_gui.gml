...
draw_text(4, 4, string_hash_to_newline(gui_health()));
if (oControl.hudflash) {
draw_set_font(oControl.guifont1a);
draw_text_color(4, 4, string_hash_to_newline(gui_health()), c_white, c_white, c_white, c_white, oControl.hudflashfx / 4);
}
etankxoff = 32;
if (global.etanks >= 1) {
...
draw_text(0 + xoff + 19, 7, string_hash_to_newline(string(global.missiles)));
...
draw_text(xoff + 19, 7, string_hash_to_newline(string(global.smissiles)));
if (global.opmslstyle == 0) {
...
draw_background(bgGUISmsl, xoff, 0);
draw_text(xoff + 19, 7, string_hash_to_newline(string(global.pbombs)));
if (global.opmslstyle == 0) {
...
draw_text(xoff + 6 + widescreen_space, 21, string_hash_to_newline(to_string_lz(global.monstersarea)));
}
if (global.ophudshowmetrcount == 2) {
draw_background(bgGUIMetCountBG2, xoff + 4 + widescreen_space, 4);
draw_text(xoff + 6 + widescreen_space, 21, string_hash_to_newline(to_string_lz(global.monstersleft)));
}
}
