...
} else with (oA4BlastDoor) instance_destroy();
if (global.event[203] > 0 && global.event[203] < 9) with (oA4EscapeControl) {
    gototemp = 100;
    alarm[0] = 1;
}
if (global.event[203] == 0 || global.event[203] == 9) mus_change(musArea4B);